...
SET @release_ddl = IF((SELECT COUNT(*) FROM information_schema.COLUMNS WHERE TABLE_SCHEMA=DATABASE() AND TABLE_NAME='nb_admin' AND COLUMN_NAME='upwd' AND COLUMN_TYPE='varchar(255)' AND IS_NULLABLE='NO')=0, 'ALTER TABLE `nb_admin` MODIFY COLUMN `upwd` varchar(255) NOT NULL', 'SELECT 1');
PREPARE release_ddl FROM @release_ddl;
EXECUTE release_ddl;
DEALLOCATE PREPARE release_ddl;
SET @release_ddl = IF((SELECT COUNT(*) FROM information_schema.COLUMNS WHERE TABLE_SCHEMA=DATABASE() AND TABLE_NAME='nb_admin' AND COLUMN_NAME='email')=0, 'ALTER TABLE `nb_admin` ADD COLUMN `email` varchar(190) DEFAULT NULL', 'SELECT 1');
PREPARE release_ddl FROM @release_ddl;
EXECUTE release_ddl;
DEALLOCATE PREPARE release_ddl;
SET @release_ddl = IF((SELECT COUNT(*) FROM information_schema.COLUMNS WHERE TABLE_SCHEMA=DATABASE() AND TABLE_NAME='nb_admin' AND COLUMN_NAME='login_fail_count')=0, 'ALTER TABLE `nb_admin` ADD COLUMN `login_fail_count` int NOT NULL DEFAULT ''0''', 'SELECT 1');
PREPARE release_ddl FROM @release_ddl;
EXECUTE release_ddl;
DEALLOCATE PREPARE release_ddl;
SET @release_ddl = IF((SELECT COUNT(*) FROM information_schema.COLUMNS WHERE TABLE_SCHEMA=DATABASE() AND TABLE_NAME='nb_admin' AND COLUMN_NAME='login_locked_until')=0, 'ALTER TABLE `nb_admin` ADD COLUMN `login_locked_until` datetime DEFAULT NULL', 'SELECT 1');
PREPARE release_ddl FROM @release_ddl;
EXECUTE release_ddl;
DEALLOCATE PREPARE release_ddl;
SET @release_ddl = IF((SELECT COUNT(*) FROM information_schema.COLUMNS WHERE TABLE_SCHEMA=DATABASE() AND TABLE_NAME='nb_admin' AND COLUMN_NAME='last_login_at')=0, 'ALTER TABLE `nb_admin` ADD COLUMN `last_login_at` datetime DEFAULT NULL', 'SELECT 1');
PREPARE release_ddl FROM @release_ddl;
EXECUTE release_ddl;
DEALLOCATE PREPARE release_ddl;
SET @release_ddl = IF((SELECT COUNT(*) FROM information_schema.COLUMNS WHERE TABLE_SCHEMA=DATABASE() AND TABLE_NAME='nb_admin' AND COLUMN_NAME='password_changed_at')=0, 'ALTER TABLE `nb_admin` ADD COLUMN `password_changed_at` datetime DEFAULT NULL', 'SELECT 1');
PREPARE release_ddl FROM @release_ddl;
EXECUTE release_ddl;
DEALLOCATE PREPARE release_ddl;
SET @release_ddl = IF((SELECT COUNT(*) FROM information_schema.COLUMNS WHERE TABLE_SCHEMA=DATABASE() AND TABLE_NAME='nb_admin' AND COLUMN_NAME='password_must_change')=0, 'ALTER TABLE `nb_admin` ADD COLUMN `password_must_change` tinyint(1) NOT NULL DEFAULT ''0''', 'SELECT 1');
PREPARE release_ddl FROM @release_ddl;
EXECUTE release_ddl;
DEALLOCATE PREPARE release_ddl;
SET @release_ddl = IF((SELECT COUNT(*) FROM information_schema.COLUMNS WHERE TABLE_SCHEMA=DATABASE() AND TABLE_NAME='nb_admin' AND COLUMN_NAME='login_token')=0, 'ALTER TABLE `nb_admin` ADD COLUMN `login_token` varchar(64) DEFAULT NULL', 'SELECT 1');
PREPARE release_ddl FROM @release_ddl;
EXECUTE release_ddl;
DEALLOCATE PREPARE release_ddl;
SET @release_ddl = IF((SELECT COUNT(*) FROM information_schema.COLUMNS WHERE TABLE_SCHEMA=DATABASE() AND TABLE_NAME='nb_admin' AND COLUMN_NAME='role_code')=0, 'ALTER TABLE `nb_admin` ADD COLUMN `role_code` varchar(16) NOT NULL DEFAULT ''admin''', 'SELECT 1');
PREPARE release_ddl FROM @release_ddl;
EXECUTE release_ddl;
DEALLOCATE PREPARE release_ddl;
SET @release_ddl = IF((SELECT COUNT(*) FROM information_schema.COLUMNS WHERE TABLE_SCHEMA=DATABASE() AND TABLE_NAME='nb_admin' AND COLUMN_NAME='idle_locked_at')=0, 'ALTER TABLE `nb_admin` ADD COLUMN `idle_locked_at` datetime DEFAULT NULL', 'SELECT 1');
PREPARE release_ddl FROM @release_ddl;
EXECUTE release_ddl;
DEALLOCATE PREPARE release_ddl;
SET @release_ddl = IF((SELECT COUNT(*) FROM information_schema.COLUMNS WHERE TABLE_SCHEMA=DATABASE() AND TABLE_NAME='nb_admin' AND COLUMN_NAME='created_at')=0, 'ALTER TABLE `nb_admin` ADD COLUMN `created_at` datetime DEFAULT NULL', 'SELECT 1');
PREPARE release_ddl FROM @release_ddl;
EXECUTE release_ddl;
DEALLOCATE PREPARE release_ddl;
SET @release_ddl = IF((SELECT COUNT(*) FROM information_schema.COLUMNS WHERE TABLE_SCHEMA=DATABASE() AND TABLE_NAME='nb_admin' AND COLUMN_NAME='updated_at')=0, 'ALTER TABLE `nb_admin` ADD COLUMN `updated_at` datetime DEFAULT NULL', 'SELECT 1');
PREPARE release_ddl FROM @release_ddl;
EXECUTE release_ddl;
DEALLOCATE PREPARE release_ddl;
...
CREATE TABLE IF NOT EXISTS `blue_schema_migrations` (
  `version` varchar(32) NOT NULL,
  `applied_at` datetime NOT NULL,
  PRIMARY KEY (`version`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
UPDATE nb_admin SET last_login_at=NOW() WHERE sitekey='BLUESQ' AND last_login_at IS NULL;
UPDATE nb_admin SET password_changed_at=NOW() WHERE sitekey='BLUESQ' AND password_changed_at IS NULL;
UPDATE nb_admin SET created_at=NOW() WHERE sitekey='BLUESQ' AND created_at IS NULL;
UPDATE nb_admin SET role_code='super' WHERE sitekey='BLUESQ' AND active_status='Y' AND (SELECT n FROM (SELECT COUNT(*) n FROM nb_admin WHERE sitekey='BLUESQ' AND active_status='Y') a)=1 AND NOT EXISTS (SELECT 1 FROM (SELECT no FROM nb_admin WHERE sitekey='BLUESQ' AND role_code='super') b);
INSERT IGNORE INTO blue_schema_migrations(version,applied_at) VALUES('202609210001_security',NOW());
INSERT IGNORE INTO blue_schema_migrations(version,applied_at) VALUES('202609210002_account_management',NOW());
