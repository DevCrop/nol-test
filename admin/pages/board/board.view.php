...
<?php
    ...
    $searchParam = htmlspecialchars(http_build_query(['board_no'=>$board_no, 'page'=>$page, 'sdate'=>$sdate, 'edate'=>$edate]), ENT_QUOTES, 'UTF-8');
                        ...
                        <div class="no-card">
                            ...
                            <div class="no-card-body no-admin-column no-admin-column--detail">
                                ...
                                <div class="no-admin-block no-admin-pos">
                                    ...
                                    <div class="no-admin-content">
                                        <input type="text" name="title" id="title" value="<?= htmlspecialchars(htmlspecialchars_decode((string) $data['title'], ENT_QUOTES), ENT_QUOTES, 'UTF-8') ?>" class="no-input--detail" placeholder="제목을 입력해주세요." />
                                    </div>
                                </div>

								<div class="no-admin-block">
									<h3 class="no-admin-title"><label for="title">게시글 노출</label></h3>
									<div class="no-admin-content">
										<div class="no-radio-form">
											<label for="input1">
												<div class="no-radio-box">
													<input type="radio" name="is_view" id="input1" value="Y" <?= $data['is_view'] == "Y" ? 'checked' : '' ?> />
											...
											<label for="input2">
												<div class="no-radio-box">
												<input type="radio" name="is_view" id="input2" value="N" <?= $data['is_view'] == "N" ? 'checked' : '' ?> />
													<span><i class="bx bx-radio-circle-marked"></i></span>
												</div>
                                ...
                                <div class="no-admin-block no-admin-field">
                                    ...
                                    <div class="no-admin-content">
                                        ...
                                        <span class="no-admin-info">
                                            zip, xls, xlsx, pdf, ppt, pptx, word, doc, docx, hwp 파일만 등록 가능합니다.
                                        </span>
                                    </div>
                                </div>
                                <!-- admin-block -->
                                ...
                                <!-- 내용 -->
                                <?php $contents = htmlspecialchars(\Security\HtmlSanitizer::clean((string) $data['contents']), ENT_QUOTES, 'UTF-8'); ?>
                                <div class="no-admin-block">
                                    <h3 class="no-admin-title">
