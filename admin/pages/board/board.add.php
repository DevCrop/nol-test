                    ...
                    <div class="no-toolbar-container">
                        <div class="no-card">
                            ...
                            <div class="no-card-body no-admin-column no-admin-column--detail">
								...
								<div class="no-admin-block no_table_category_depth "  style="display:none;">
                                    <h3 class="no-admin-title">
                                        <label for="category_no">
                                            게시판 카테고리 분류
                                        </label>
										...
										<div class="no-radio-form">
											<label for="input1">
												<div class="no-radio-box">
													<input type="radio" name="is_view" id="input1" value="Y" checked />
											...
											<label for="input2">
												<div class="no-radio-box">
													<input type="radio" name="is_view" id="input2" value="N" />
													<span><i class="bx bx-radio-circle-marked"></i></span>
												</div>
                                ...
                                <div class="no-admin-block">
                                    ...
                                    <div class="no-admin-content">
                                        ...
                                        <span class="no-admin-info"><i class="bx bxs-info-circle"></i> zip, xls, xlsx, pdf, ppt, pptx, word, doc, docx, hwp 파일만 등록 가능합니다.</span>
                                    </div>
                                </div>
